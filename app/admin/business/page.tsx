...
export default function BusinessPage() {
    ...
    async function loadBusinesses() {
        try {
            ...
            /*
             * Önce mevcut kullanıcının rolünü öğreniyoruz.
             * Böylece ADMIN iken /businesses endpointine
             * gereksiz request atmıyoruz.
             */
                ...
                <div className="bg-[#111827] border border-white/10 rounded-2xl p-16 text-center">
                    ...
                    {role === "SUPER_ADMIN" && (
                        <button
                            ...
                            className="mt-6 bg-blue-600 hover:bg-blue-500 px-5 py-3 rounded-xl font-semibold"
                        >
                            + Create Business
                        </button>
                    )}
                                ...
                                <div className="mt-6 grid grid-cols-2 gap-3">
                                    ...
                                    {role ===
                                        ...
                                        business.subscriptionStatus ===
                                            ...
                                            <button
                                                ...
                                                className="bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/20 text-orange-400 py-2.5 rounded-lg text-sm font-medium transition"
                                            >
                                                End Trial
                                            </button>
                                        )}
                                    ...
                                    {role ===
                                        ...
                                        <button
                                            ...
                                            className="bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 text-red-400 py-2.5 rounded-lg text-sm font-medium transition"
                                        >
                                            Delete
                                        </button>
                                    )}
            ...
            {showCreateModal &&
                role === "SUPER_ADMIN" && (
                    ...
                    >
                        ...
                        <div className="w-full max-w-2xl bg-[#111827] border border-white/10 rounded-2xl shadow-2xl">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-3">
                                                ...
                                                <input
                                                    ...
                                                    className="flex-1 bg-[#0b1120] border border-white/10 rounded-xl px-4 py-3 outline-none focus:border-blue-500"
                                                />
